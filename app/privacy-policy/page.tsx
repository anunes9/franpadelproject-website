...
const Page = () => {
  return (
    <div className="min-h-screen pt-28 lg:pt-36 pb-20">
      <div className="px-4 max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto">
        <h1 className="font-display font-black text-4xl md:text-5xl text-white uppercase tracking-tight mb-8">
          Privacy Policy
        </h1>

        <div className="bg-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-sm border border-slate-100">
          <Text className="mb-6 !text-slate-500">Last Updated: 21 Jan 2024</Text>
