...
export const Hero = ({ locale }: { locale: string }) => (
  <>
    ...
    <div className="absolute w-screen h-screen h-max-[1000px]">
      <div className="h-full flex flex-col justify-between items-center">
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          <Image src="/assets/fran-logo.png" alt="arrow-down" width="264" height="164" />
        </div>
    ...
    <video className="w-screen h-screen h-max-[1000px] object-cover" autoPlay loop muted src="/assets/video.mov" />
  </>
)
