...
export const Footer = () => (
  <footer className="relative bg-projectBlue w-full text-white flex flex-col justify-center py-12 sm:h-[280px] font-projectFontMediumExtended">
    <div className="w-[90%] max-w-[1200px] mx-auto flex flex-col md:flex-row gap-12 sm:gap-0 items-center justify-between mb-4 md:px-12">
