import { MapPin, Calendar, Play, ChevronRight, Globe, Zap, Target, Users } from 'lucide-react'
...
function PhotoPlaceholder({ index, className = '' }: { index: number; className?: string }) {
  return (
    <div
      className={`relative overflow-hidden bg-fran-navy/60 border border-white/10 ${className}`}
      style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%2368bfa3' fill-opacity='0.04'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
      }}
    >
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-white/20">
        ...
        <span className="text-xs font-mono tracking-widest uppercase opacity-60">Photo {index}</span>
      </div>
      <div
        className="absolute inset-0 opacity-10"
        style={{ background: 'linear-gradient(135deg, transparent 40%, rgba(104,191,163,0.3) 100%)' }}
      />
    </div>
  )
}
...
export default function IBERecap({ locale: _locale }: IBERecapProps) {
  return (
    <>
      <style>{`
        @keyframes ibe-up {
      ...
      <div className="min-h-screen overflow-x-hidden" style={{ background: '#0a1e33' }}>
        ...
        <section className="relative min-h-[100svh] flex flex-col justify-end overflow-hidden">
          ...
          <div
            ...
            style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(104,191,163,0.08) 0%, transparent 70%)' }}
          />
          <div
            className="absolute inset-0 pointer-events-none"
            style={{ background: 'linear-gradient(160deg, transparent 55%, rgba(104,191,163,0.04) 55.1%, rgba(104,191,163,0.04) 100%)' }}
          />
          <div
          ...
          <div className="relative z-10 container max-w-7xl mx-auto px-6 pb-20 pt-40">
            ...
            >
              ...
              <span
                className="block"
                style={{
                  background: 'linear-gradient(90deg, #68bfa3 0%, #a8dfd0 50%, #68bfa3 100%)',
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-8 mt-8">
              ...
              <div className="ml-auto hidden sm:block">
                ...
                <p className="text-white/20 text-xs font-mono tracking-widest uppercase rotate-90 origin-top-left translate-x-full -translate-y-2">Scroll</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-fran-teal text-xs font-mono tracking-widest uppercase">About the Event</span>
                </div>
                <h2
                ...
                <div className="space-y-4 text-white/60 leading-relaxed text-base md:text-lg">
                  <p>
                    The Iberian Padel Experience is one of the most intensive padel events in the FRAN Padel Project calendar — a multi-day immersion in Madrid designed for players who want to train, think, and compete at a higher level.
                  </p>
                  <p>
              ...
              <div className="relative">
                <PhotoPlaceholder index={1} className="w-full aspect-[4/3] clip-corner-br" />
        ...
        <section className="py-24 relative overflow-hidden">
          <div
            ...
            style={{ background: 'radial-gradient(ellipse 100% 50% at 50% 50%, rgba(18,44,73,0.8) 0%, transparent 100%)' }}
          />
            ...
            <div className="flex items-end justify-between mb-12 ibe-reveal">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-px bg-fran-teal" />
                  <span className="text-fran-teal text-xs font-mono tracking-widest uppercase">Gallery</span>
                </div>
                <h2 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tighter leading-tight">
                  Captured<br /><span className="outline-text">Moments</span>
                </h2>
              </div>
              <p className="text-white/30 text-sm font-mono tracking-widest uppercase hidden md:block text-right">
                Photos<br />Arriving Soon
              </p>
            </div>

            <div className="grid grid-cols-12 grid-rows-[auto_auto] gap-3 ibe-reveal">
              <PhotoPlaceholder index={2} className="col-span-12 md:col-span-7 row-span-2 aspect-[4/3] md:aspect-auto md:min-h-[480px]" />
              <PhotoPlaceholder index={3} className="col-span-6 md:col-span-5 aspect-square" />
              <PhotoPlaceholder index={4} className="col-span-6 md:col-span-5 aspect-square" />
            </div>

            <div className="grid grid-cols-3 gap-3 mt-3 ibe-reveal ibe-reveal-delay-1">
              <PhotoPlaceholder index={5} className="col-span-1 aspect-video" />
              <PhotoPlaceholder index={6} className="col-span-1 aspect-video" />
              <PhotoPlaceholder index={7} className="col-span-1 aspect-video" />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 border-t border-white/5">
          <div className="container max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-4 ibe-reveal">
              <div className="w-8 h-px bg-fran-teal" />
              <span className="text-fran-teal text-xs font-mono tracking-widest uppercase">Highlights</span>
            </div>
              ...
              {MOMENTS.map((m, i) => (
                ...
                >
                  <div
                    ...
                    style={{ color: 'rgba(104,191,163,0.06)', fontSize: '6rem' }}
                    aria-hidden
                  >
        ...
        <section className="py-24 border-t border-white/5">
          <div className="container max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-px bg-fran-teal" />
              <span className="text-fran-teal text-xs font-mono tracking-widest uppercase">Video</span>
            </div>
            ...
            >
              ...
              <div
                ...
                style={{ backgroundImage: `repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(104,191,163,0.5) 2px, rgba(104,191,163,0.5) 3px)` }}
              />
              <div className="relative z-10 flex flex-col items-center justify-center min-h-[320px] md:min-h-[480px] gap-6 p-12">
                <div className="w-20 h-20 rounded-full border-2 border-fran-teal flex items-center justify-center bg-fran-teal/10 group-hover:bg-fran-teal group-hover:scale-110 transition-all duration-300">
                  <Play className="w-8 h-8 ml-1 text-fran-teal group-hover:text-fran-navy transition-colors duration-300" fill="currentColor" />
                </div>
                <div className="text-center">
                  <p className="text-white font-display font-black text-2xl md:text-3xl uppercase tracking-tight mb-2">Event Highlights Reel</p>
                  <p className="text-white/40 text-sm font-mono tracking-widest uppercase">Video Coming Soon</p>
                </div>
                <div className="flex gap-1 mt-2">
                  {[18, 10, 28, 14, 22, 8, 30, 16, 24, 12, 20, 26].map((h, i) => (
                    <div key={i} className="w-1 rounded-full bg-fran-teal/40" style={{ height: `${h}px` }} />
                  ))}
                </div>
              </div>
            </div>
        ...
        <section className="py-24 relative overflow-hidden">
          <div
            className="absolute inset-0"
            style={{ background: 'linear-gradient(135deg, rgba(104,191,163,0.04) 0%, transparent 50%)' }}
          />
          <div className="relative z-10 container max-w-5xl mx-auto px-6 text-center ibe-reveal">
            <div className="relative inline-block">
              ...
              <blockquote className="relative font-display font-black text-2xl md:text-4xl lg:text-5xl text-white uppercase tracking-tighter leading-tight mb-10">
                Every player who steps onto that court in Madrid leaves a different athlete.
              </blockquote>
            </div>
            <div className="flex items-center justify-center gap-4">
              <div className="w-12 h-px bg-fran-teal/40" />
              <div>
                <p className="text-white font-bold text-sm uppercase tracking-wider">Francisco Freitas</p>
                <p className="text-fran-teal text-xs font-mono tracking-widest uppercase mt-0.5">Founder, FRAN Padel Project</p>
              </div>
              <div className="w-12 h-px bg-fran-teal/40" />
            </div>
          </div>
          ...
          <div className="relative z-10 container max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 ibe-reveal">
              <div className="max-w-xl">
                <span className="text-fran-teal text-xs font-mono tracking-widest uppercase mb-4 block">Next Edition</span>
                ...
                <p className="text-white/50 text-base md:text-lg leading-relaxed">
                  Spots are limited to 8–16 players. Get in touch to reserve your place in the next edition of the Iberian Padel Experience in Madrid.
                </p>
              </div>
