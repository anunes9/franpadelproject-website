...
const ClinicDetails = ({ clinic, locale }: { clinic: any; locale: string }) => (
  <div className="w-full m-auto my-16">
    <div className={`bg-project${clinic.color} px-8 sm:px-16 lg:px-[123px] pt-12 sm:pt-24 lg:pt-[200px] pb-12 z-20`}>
      {clinic.image && (
        <Image alt={clinic.name} src={clinic.image.url} height={clinic.image.height} width={clinic.image.width} />
      )}
