...
export const CLINICS: ServiceItem[] = [
  {
    ...
    features: [
      'Intensive experience in Spain',
      'Groups of 8 to 16 people',
...
export const WORLD_LOCATIONS = [
  ...
  { name: 'Amsterdam', country: 'Netherlands', products: ['Master Clinic'] },
  {
    name: 'Talatona',
    country: 'Angola',
    products: ['Master Clinic', 'Fran Methodology'],
  },
  {
    name: 'Lisbon',
    country: 'Portugal',
    products: ['Padel Wonderland', 'Master Clinic', 'Master Clinic Evolution'],
  },
...
export const SPONSORS: Sponsor[] = [
  {
    name: 'Cork',
    logo: '/assets/cork.png',
    url: 'https://www.corkpadel.com/en/',
  },
  {
    name: 'DFL',
    logo: '/assets/DFL.png',
    url: 'https://www.instagram.com/dfl.selectedmeat/',
  },
  {
    name: 'Proframe',
    logo: '/assets/proframe.png',
    url: 'https://www.instagram.com/pro.frame_/',
  },
  {
    name: 'AN',
    logo: '/assets/an-logo-color.svg',
    url: 'https://anunes9.github.io/me/',
  },
]

export const IBE_GALLERY_IMAGES: string[] = [
  'IBE/ABRIL_DIA_1/FP_IBE2026_abril-1.jpg',
  'IBE/ABRIL_DIA_1/FP_IBE2026_abril-2.jpg',
  'IBE/ABRIL_DIA_1/FP_IBE2026_abril-4.jpg',
  'IBE/ABRIL_DIA_1/FP_IBE2026_abril-35.jpg',
  'IBE/ABRIL_DIA_2/FP_IBE2026_abril-9.jpg',
  'IBE/ABRIL_DIA_2/FP_IBE2026_abril-21.jpg',
  'IBE/ABRIL_DIA_2/FP_IBE2026_abril-49.jpg',
  'IBE/ABRIL_DIA_2/FP_IBE2026_abril-32.jpg',
]
